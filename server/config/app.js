/* server/config/app.js - Chloe Baker - 301062067 - October 22, 2020 */
...
let contactsRouter = require('../routes/contact'); //for the business_contacts db
...
app.use('/contacts-list', contactsRouter); //for the business_contacts db
